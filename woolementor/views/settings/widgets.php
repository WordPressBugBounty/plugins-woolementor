...
<div id="wl-pro-popup" style="display: none;">
	...
	<p class="wl-pro-popup-txt"><?php esc_attr_e( 'This feature is only available in <strong>CoDesigner Pro</strong>!', 'codesigner' ); ?></p>
	<p class="wl-pro-popup-txt"><?php esc_attr_e( 'Make a smart choice today; a <strong>small investment</strong> can lead to a <strong>big boost</strong> in your sales. Your decision can make a significant difference.', 'codesigner' ); ?></p>
