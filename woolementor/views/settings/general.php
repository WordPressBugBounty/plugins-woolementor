                    ...
                    <div class="cd-premium-features-wrapper">
                        ...
                        <div class="cd-upgrade-cta">
                            ...
                            <div class="cd-btn-wrapper">
                                <a id="upgrade-now" target="_blank" href="<?php echo esc_url( 'https://codexpert.io/codesigner/pricing?utm_source=in+plugin&utm_medium=getting+started&utm_campaign=get+pro' ); ?>" class="cd-btn">
