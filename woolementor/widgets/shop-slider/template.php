...
<div class="wl-ssl-product-style">
	...
	<div class="cx-container">
		<div class="wl-ssl-slider wl-ssl-slick-<?php echo esc_attr( $section_id ); ?>">
							 	...
							 	<div class="wl-ssl-product-details">
                                		...
                                		<?php do_action( 'codesigner_after_shop_loop_item_title' ); ?>
									   	...
									   	<?php if( 'yes' == $settings['short_description_show_hide'] ): ?>
									   		<div class="wl-ssl-product-desc">
									   			<p>
									   				<?php echo esc_html( wp_trim_words( $product->get_short_description(), $product_desc_words_count ) ); ?>
									   			</p>
									   		</div>
									   	<?php endif; ?>
									...
									<div class="wl-ssl-info-icons">
										...
										if ( 'yes' == $cart_show_hide ):
											...
											<?php else: ?>
												<div class="wl-ssl-product-cart">
													<a href="<?php echo esc_url( get_permalink( $product_id ) ); ?>" data-quantity="1" class="product_type_<?php echo esc_attr( $product->get_type() ); ?>" data-product_id="<?php echo esc_attr( $product_id ); ?>">
...
<script type="text/javascript">
    jQuery(function($){
    	...
    	var config				= <?php echo wp_json_encode( $slick_config ); ?>;
